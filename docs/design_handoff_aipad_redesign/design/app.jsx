...
function Tab({ label, status, active, accent }) {
  ...
  return (
    <div style={{
      ...
      <span style={{ width: 14, height: 14, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-4)', fontSize: 11 }}>×</span>
    </div>
  );
}
...
Object.assign(window, { STATUSES, StatusBadge, AppGlyph, TitleBar, Tab, TabBar, StatusOverview, SessionRow, Sidebar, WindowControls });
